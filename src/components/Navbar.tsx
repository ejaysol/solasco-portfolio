        ...
        <div className="hidden md:flex items-center space-x-8">
          {navLinks.map((link) => (
            <a
              key={link.name}
              href={link.href}
              className="text-sm font-medium tracking-wide text-slate-600 dark:text-slate-300 hover:text-[#00f0ff] dark:hover:text-[#00f0ff] transition-colors duration-200"
            >
              {link.name}
            </a>
          ))}
          ...
          <button
            onClick={toggleTheme}
            className="p-2 rounded-xl bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 text-slate-600 dark:text-slate-300 hover:text-[#00f0ff] transition-all duration-300 hover:scale-110 active:scale-95 flex items-center justify-center cursor-pointer"
          ...
          <div className="flex items-center space-x-3">
            <a
              ...
              className="w-9 h-9 rounded-xl bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 text-slate-600 dark:text-slate-400 hover:text-[#bd00ff] dark:hover:text-[#bd00ff] hover:border-[#bd00ff]/30 transition-all duration-300 hover:scale-110 active:scale-95 flex items-center justify-center cursor-pointer"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 rounded-xl bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 text-slate-600 dark:text-slate-400 hover:text-[#00f0ff] dark:hover:text-[#00f0ff] hover:border-[#00f0ff]/30 transition-all duration-300 hover:scale-110 active:scale-95 flex items-center justify-center cursor-pointer"
      ...
      >
        {navLinks.map((link) => (
          <a
            ...
            className="text-base font-medium text-slate-700 dark:text-slate-300 hover:text-[#00f0ff] dark:hover:text-[#00f0ff] transition-colors duration-200"
          >
            {link.name}
          </a>
        ))}
        ...
        <div className="flex items-center space-x-4 py-2">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 rounded-xl bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 text-slate-600 dark:text-slate-400 hover:text-[#bd00ff] dark:hover:text-[#bd00ff] hover:border-[#bd00ff]/30 transition-all duration-300 hover:scale-110 active:scale-95 flex items-center justify-center cursor-pointer"
            aria-label="GitHub Profile - ejaysol"
          >
