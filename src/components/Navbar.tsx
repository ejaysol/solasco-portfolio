    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <button
            onClick={toggleTheme}
            className="p-2 rounded-xl bg-white/5 border border-white/10 text-slate-300 hover:text-[#00f0ff] transition-all duration-300 hover:scale-110 active:scale-95 flex items-center justify-center cursor-pointer"
          ...
          <div className="flex items-center space-x-4">
            <a
              ...
              className="text-slate-400 hover:text-[#bd00ff] transition-colors duration-200"
        ...
        <div className="md:hidden flex items-center space-x-4">
          ...
          <button
            ...
            className="text-slate-300 hover:text-[#00f0ff] transition-colors duration-200 focus:outline-none"
          >
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden glass-nav border-t border-white/5 absolute top-full left-0 w-full py-6 px-8 flex flex-col space-y-4 shadow-xl">
          {navLinks.map((link) => (
            <a
              key={link.name}
              href={link.href}
